...
const addTransaction = (req, res, next) => {
  try {
    ...
    saveBlockchainState(blockchain, persistenceService, 'adding unsigned transaction');
...
module.exports = { addTransaction, getPendingTransactions, getAllTransactions, signAndAddTransaction };
