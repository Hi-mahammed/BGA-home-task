...
module.exports = {
  ...
  demoData: {
    // Demo data disabled by default since transactions now require valid ECDSA signatures
    // Enable with SEED_DEMO_DATA=true if restoring from a saved state or using test wallets
